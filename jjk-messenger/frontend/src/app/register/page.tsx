...
export default function RegisterPage() {
  ...
  const [showConfirmPassword, setShowConfirmPassword] = useState(false); // Nouvel état pour la visibilité de la confirmation du mot de passe
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Rediriger vers la page de connexion avec un message de succès après un délai
      setTimeout(() => {
        router.push('/login?registered=true');
      }, 3000); // Redirige après 3 secondes
    } catch (err: unknown) {
      toast.error(getApiErrorMessage(err, 'Une erreur est survenue lors de l\'inscription'));
    }
  };
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/register-bg.jpg')" }} // Assurez-vous que l'image existe dans public/images/
      >
      ...
      <div className="relative z-10 w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg animate-fadeIn"> {/* z-10, shadow-lg, et animate-fadeIn ajoutés */}
        <div className="text-center mb-6"> {/* Ajout de mb-6 */}
          ...
          <h2 className="text-xl font-semibold text-gray-700">Inscription</h2> {/* Espacement autour du sous-titre */}
        </div>
          ...
          <div>
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                {/* Insérez votre icône utilisateur SVG ici */}
