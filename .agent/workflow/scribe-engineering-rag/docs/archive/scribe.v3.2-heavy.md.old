...
#              Pour le tooling SCRIBE : lire les fichiers tooling directement
#              ou construire un graphe séparé, jamais polluer le graphe app.
#
...
#
# COUCHE 3 — SCRIBE-RAG ENGINEERING (laboratoire, non canonique)
#   Dossier  : .agent/workflow/scribe-engineering-rag/
